...
export interface Concern {
  ...
  // Worker-uploaded pictures of the risk on site. Synced records carry
  // API-relative URLs into the backend's file storage; records still queued
  // offline carry the on-device data URL. Render via resolveFileUrl().
  photos?: string[]
